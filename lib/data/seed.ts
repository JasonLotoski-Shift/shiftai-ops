...
export const deals: Deal[] = [
  { id: "d-1", contactId: "c-1", company: "Cascade Heavy Civil", stage: "negotiation", valueEstimate: 480000, partnerLeadId: "p-1", industry: "construction", closeTargetDate: "2026-05-22", createdAt: "2026-03-04", lastTouchAt: "2026-05-08", notes: "MSA red-lines back from legal. Operating-sponsor sign-off pending." },
  { id: "d-2", contactId: "c-2", company: "Northshore Powertrain", stage: "proposal", valueEstimate: 320000, partnerLeadId: "p-2", industry: "automotive", closeTargetDate: "2026-06-15", createdAt: "2026-03-28", lastTouchAt: "2026-05-10", notes: "SOW v2 out. They asked for a phased pilot." },
  { id: "d-3", contactId: "c-3", company: "Westline Engineering", stage: "discovery", valueEstimate: 280000, partnerLeadId: "p-3", industry: "engineering", closeTargetDate: "2026-07-01", createdAt: "2026-04-15", lastTouchAt: "2026-05-09", notes: "On-site embed week 1 of June. Need to confirm two operator interviews." },
  { id: "d-4", contactId: "c-4", company: "Apex Racing Group", stage: "qualified", valueEstimate: 180000, partnerLeadId: "p-4", industry: "motorsport", closeTargetDate: "2026-06-30", createdAt: "2026-05-01", lastTouchAt: "2026-05-11", notes: "Connor wants a discovery scoped before September race calendar locks." },
  { id: "d-5", contactId: "c-5", company: "Granite Bay Auto Group", stage: "lead", valueEstimate: 240000, partnerLeadId: "p-2", industry: "automotive", closeTargetDate: "2026-08-01", createdAt: "2026-02-18", lastTouchAt: "2026-04-02", notes: "Cold for 5+ weeks. Re-engage." },
  { id: "d-6", contactId: "c-6", company: "Iron Spur Construction", stage: "proposal", valueEstimate: 360000, partnerLeadId: "p-1", industry: "construction", closeTargetDate: "2026-06-05", createdAt: "2026-04-10", lastTouchAt: "2026-05-05", notes: "Field-ops dispatch system. Ready to scope build." },
  { id: "d-7", contactId: "c-7", company: "Halifax Marine Engineering", stage: "lead", valueEstimate: 220000, partnerLeadId: "p-3", industry: "engineering", closeTargetDate: "2026-09-01", createdAt: "2026-01-10", lastTouchAt: "2026-03-18", notes: "Long cold. Lena moved roles internally — verify decision authority." },
  { id: "d-8", contactId: "c-8", company: "Crown Performance Engines", stage: "discovery", valueEstimate: 140000, partnerLeadId: "p-4", industry: "motorsport", closeTargetDate: "2026-07-15", createdAt: "2026-04-22", lastTouchAt: "2026-05-09", notes: "Small but strategic — racing IP." },
  { id: "d-9", contactId: "c-9", company: "Vanguard Steelworks", stage: "qualified", valueEstimate: 410000, partnerLeadId: "p-1", industry: "construction", closeTargetDate: "2026-08-15", createdAt: "2026-04-29", lastTouchAt: "2026-05-07" },
  { id: "d-10", contactId: "c-10", company: "Lakeshore Dealership Group", stage: "discovery", valueEstimate: 270000, partnerLeadId: "p-2", industry: "automotive", closeTargetDate: "2026-07-30", createdAt: "2026-04-25", lastTouchAt: "2026-05-11" },
  { id: "d-11", contactId: "c-11", company: "Meridian Civil Engineers", stage: "qualified", valueEstimate: 195000, partnerLeadId: "p-3", industry: "engineering", closeTargetDate: "2026-08-20", createdAt: "2026-05-01", lastTouchAt: "2026-05-04" },
];
